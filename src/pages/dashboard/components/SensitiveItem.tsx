...
export default function SensitiveItem({
  ...
  return (
    <div
      onClick={onClick}
      className={`flex cursor-pointer items-start gap-4 rounded-2xl border p-5 transition-colors max-md:gap-3 max-md:p-4 ${
        isActive ? 'border-violet-500 bg-violet-50' : 'border-gray-100 bg-white hover:bg-gray-50'
      }`}
    >
      <div
        className={`flex size-7 shrink-0 items-center justify-center rounded-full text-sm font-semibold transition-colors ${
      ...
      <div className="min-w-0 flex-1">
        <div className="mb-1.5 flex items-center gap-2 max-md:flex-wrap">
      ...
      <div className="flex shrink-0 items-center gap-2">
        ...
        <button
          ref={buttonRef}
          onClick={openMenu}
          className="flex size-7 items-center justify-center rounded-full text-gray-500 transition-colors hover:bg-gray-200"
        >
